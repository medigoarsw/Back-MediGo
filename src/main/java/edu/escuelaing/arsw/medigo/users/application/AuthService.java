 ...
 * 
 * La nueva ubicación sigue la arquitectura hexagonal correctamente.
 */
@Deprecated(since = "1.0", forRemoval = true)
public class AuthService {
    // Esta clase se mantiene solo por compatibilidad durante la transición
    // Importa desde: edu.escuelaing.arsw.medigo.users.application.service.AuthService
}